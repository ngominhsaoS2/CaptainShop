...
namespace CaptainShop.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(IProductService productService, IBlogService blogService, ICommonService commonService, IProductCategoryService productCategoryService,
