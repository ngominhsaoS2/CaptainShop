...
using CaptainShop.Extensions;
using CaptainShop.Models;
using CaptainShop.Services;
...
namespace CaptainShop.Controllers
{
    public class CartController : Controller
    {
        ...
        public CartController(IProductService productService, IEmailSender emailSender, IConfiguration configuration, IBillService billService)
        {
