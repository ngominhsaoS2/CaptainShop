    ...
    function registerEvents() {
        ...
        $('body').on('click', '.btn-edit', function (e) {
            ...
            $.ajax({
                ...
                error: function (status) {
                    commonFunctions.notify('Có lỗi xảy ra', 'error');
                    commonFunctions.stopLoading();
                }
            });
        });
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        commonFunctions.notify('Update role successful', 'success');
                    ...
                    error: function () {
                        commonFunctions.notify('Has an error', 'error');
                        commonFunctions.stopLoading();
                    }
                });
                return false;
        ...
        $('body').on('click', '.btn-delete', function (e) {
            ...
            commonFunctions.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    success: function (response) {
                        commonFunctions.notify('Delete successful', 'success');
                        commonFunctions.stopLoading();
                        loadData();
                    },
                    error: function (status) {
        ...
        $("#btnSavePermission").off('click').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    commonFunctions.notify('Save permission successful', 'success');
                    $('#modal-grantpermission').modal('hide');
                    commonFunctions.stopLoading();
                },
                error: function () {
                    commonFunctions.notify('Has an error in save permission progress', 'error');
                    commonFunctions.stopLoading();
                }
            });
        });
